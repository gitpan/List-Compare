...
ok($lcmu->is_member_any('abel'));       # 937
ok($lcmu->is_member_any('baker'));      # 938
ok($lcmu->is_member_any('camera'));     # 939
ok($lcmu->is_member_any('delta'));      # 940
ok($lcmu->is_member_any('edward'));     # 941
ok($lcmu->is_member_any('fargo'));      # 942
ok($lcmu->is_member_any('golfer'));     # 943
ok($lcmu->is_member_any('hilton'));     # 944
ok($lcmu->is_member_any('icon' ));      # 945
ok($lcmu->is_member_any('jerky'));      # 946
ok(! $lcmu->is_member_any('zebra'));    # 947
