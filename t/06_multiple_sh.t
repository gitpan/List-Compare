...
ok($lcmsh->is_member_any('abel'));      # 438
ok($lcmsh->is_member_any('baker'));     # 439
ok($lcmsh->is_member_any('camera'));    # 440
ok($lcmsh->is_member_any('delta'));     # 441
ok($lcmsh->is_member_any('edward'));    # 442
ok($lcmsh->is_member_any('fargo'));     # 443
ok($lcmsh->is_member_any('golfer'));    # 444
ok($lcmsh->is_member_any('hilton'));    # 445
ok($lcmsh->is_member_any('icon' ));     # 446
ok($lcmsh->is_member_any('jerky'));     # 447
ok(! $lcmsh->is_member_any('zebra'));   # 448
...
ok($lcmshu->is_member_any('abel'));     # 897
ok($lcmshu->is_member_any('baker'));    # 898
ok($lcmshu->is_member_any('camera'));   # 899
ok($lcmshu->is_member_any('delta'));    # 900
ok($lcmshu->is_member_any('edward'));   # 901
ok($lcmshu->is_member_any('fargo'));    # 902
ok($lcmshu->is_member_any('golfer'));   # 903
ok($lcmshu->is_member_any('hilton'));   # 904
ok($lcmshu->is_member_any('icon' ));    # 905
ok($lcmshu->is_member_any('jerky'));    # 906
ok(! $lcmshu->is_member_any('zebra'));  # 907
