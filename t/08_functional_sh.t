...
@unique = get_Lonly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@unique);
...
$unique_ref = get_Lonly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$unique_ref});
...
@unique = get_Aonly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@unique);
...
$unique_ref = get_Aonly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$unique_ref});
...
@complement = get_Ronly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@complement);
...
$complement_ref = get_Ronly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$complement_ref});
...
@complement = get_Bonly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@complement);
...
$complement_ref = get_Bonly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$complement_ref});
...
@symmetric_difference = get_LorRonly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@symmetric_difference);
...
$symmetric_difference_ref = get_LorRonly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$symmetric_difference_ref});
...
@symmetric_difference = get_AorBonly('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@symmetric_difference);
...
$symmetric_difference_ref = get_AorBonly_ref('--unsorted', \%h0, \%h1);
$seen{$_}++ foreach (@{$symmetric_difference_ref});
