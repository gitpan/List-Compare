...
# FIRST IS MEMBER ANY
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'abel' ] ));# 267
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'baker' ] ));# 268
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'camera' ] ));# 269
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'delta' ] ));# 270
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'edward' ] ));# 271
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'fargo' ] ));# 272
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'golfer' ] ));# 273
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'hilton' ] ));# 274
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'icon' ] ));# 275
ok(is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'jerky' ] ));# 276
ok(! is_member_any( [ \%h0, \%h1, \%h2, \%h3, \%h4 ] , [ 'zebra' ] ));# 277
