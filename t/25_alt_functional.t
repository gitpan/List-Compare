...
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'abel' } ));# 222
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'baker' } ));# 223
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'camera' } ));# 224
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'delta' } ));# 225
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'edward' } ));# 226
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'fargo' } ));# 227
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'golfer' } ));# 228
ok(is_member_any( { lists => [ \@a0, \@a1 ], item => 'hilton' } ));# 229
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'icon' } ));# 230
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'jerky' } ));# 231
ok(! is_member_any( { lists => [ \@a0, \@a1 ], item => 'zebra' } ));# 232
